...
public class SolutionTest {
    ...
    @Test public void testCalc() {
        ...
        int[][] snakes2 = { { 51, 19 }, { 39, 11 }, { 37, 29 }, { 81, 3 }, { 59, 5 }, { 79, 23 }, { 53, 7 }, { 43, 33 },
                { 77, 21 } };
    ...
    @Test public void testCalcBacktrack() {

        int[][] ladders = { { 2, 40 }, { 21, 99 } };
    ...
    @Test public void testCalcImpossible() {

        int[][] ladders = { { 2, 93 } };

        int[][] snakes = { { 94, 9 }, { 95, 10 }, { 96, 11 }, { 97, 12 }, { 98, 13 }, { 99, 14 } };
    ...
    @Test public void testSkipShortcut() {

        int[][] ladders = { { 2, 4 }, { 3, 5 }, { 7, 8 }, { 9, 99 } };

        int[][] snakes = { { 10, 6 }, { 98, 86 } };
